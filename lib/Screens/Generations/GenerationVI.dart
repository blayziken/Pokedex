...
class GenerationVIScreen extends StatefulWidget {
  static const routeName = '/generation-VI';
  @override
  _GenerationVIScreenState createState() => _GenerationVIScreenState();
}

class _GenerationVIScreenState extends State<GenerationVIScreen> {
  bool _showSpinner = true;
  List<Pokemon> runPokemonList = [];

  void fetchGenerationVI() async {
    for (var num = 649; num <= 714; num++) {
